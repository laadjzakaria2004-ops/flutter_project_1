...
import '../../views/quiz/quiz_page_content.dart';
import '../dashboard/dashboard_page.dart';
import '../auth/login_page.dart';
import '../leaderboard/leaderboard_page.dart';
import '../files/files_page.dart';

class Algo2QuizSelectionPage extends StatefulWidget {
  const Algo2QuizSelectionPage({super.key});

  @override
  State<Algo2QuizSelectionPage> createState() => _Algo2QuizSelectionPageState();
}

class _Algo2QuizSelectionPageState extends State<Algo2QuizSelectionPage> {
  ...
  final List<Map<String, String>> _chapters = [
    {
      "id": "Algo2 Chapitre 01",
      "title": "Advanced Algorithm Analysis",
      "icon": "assets/images/icons_algo2/advanced_analysis.png",
    },
    {
      "id": "Algo2 Chapitre 02",
      "title": "Advanced Sorting Algorithms",
      "icon": "assets/images/icons_algo2/advanced_sorting.png",
    },
    {
      "id": "Algo2 Chapitre 03",
      "title": "Graph Algorithms",
      "icon": "assets/images/icons_algo2/graph_algorithms.png",
    },
    {
      "id": "Algo2 Chapitre 04",
      "title": "Dynamic Programming",
      "icon": "assets/images/icons_algo2/dynamic_programming.png",
    },
    {
      "id": "Algo2 Chapitre 05",
      "title": "Greedy Algorithms",
      "icon": "assets/images/icons_algo2/greedy_algorithms.png",
    },
    {
      "id": "Algo2 Chapitre 06",
      "title": "NP-Completeness",
      "icon": "assets/images/icons_algo2/np_completeness.png",
    },
  ];
        ...
        children: [
          ...
          Image.asset(
            ...
            errorBuilder: (_, __, ___) =>
                Icon(Icons.school, color: Colors.blue, size: h * 0.08),
          ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: h * 0.02),
                _buildReviewRow(h, "Difficulty Level", "$_selectedIntensity ●"),
                SizedBox(height: h * 0.02),
